      ...
      <div className="flex flex-col lg:flex-row max-w-[1752px] mx-auto gap-4 sm:gap-8 lg:gap-12">
        ...
        <div className="flex-1 flex items-center justify-center mt-4 lg:mt-0">
          <img
            ...
            alt="Web designing with social media integration and modern layouts"
            src="https://images.unsplash.com/photo-1547658719-da2b51169166?w=800&h=600&fit=crop&crop=center"
          />
        </div>
      </div>
    </section>
